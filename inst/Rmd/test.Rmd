...
params: 
  ...
  input_data_table: !r result_data #report.preprocessing::jdt_dirty
---
...
```{r cleaning_input_data, echo=FALSE, results='asis'}
...
# print(paste("input_data_table: ",deparse(substitute(params$input_data_table))))
...
} else if (!is.null(params$input_data_table)){
  jdt <- clean_jmeter_log(params$input_data_table,
...
```{r get agregated table,results = 'asis',echo=FALSE}
